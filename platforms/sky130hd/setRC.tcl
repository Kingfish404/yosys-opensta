# SKY130 HD Layer RC Values
# Sourced from OpenROAD-flow-scripts sky130hd platform (correlateRC.py
# correlation: gcd, ibex, aes, jpeg, chameleon, riscv32i, chameleon_hier).
# Capacitance units: pF/um.
