#===========================================================
# OpenROAD Physical Design Flow (Place & Route)
#
# Reads synthesized netlist + SDC from STA results,
# performs: Floorplan → Placement → CTS → Routing → Layout
#
...
# Only add upper-metal straps if the core is wide enough
